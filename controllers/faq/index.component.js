        ...
        _this.process = async () => {
            ...
            if (Object.keys(data).length > 0) {
                ...
                if(id == 0){
                    ...
                    data.code = (checkCode.length > 0 && checkCode[0].count == 2) ? ('f' + String(Math.floor(Math.random() * (9999999999999 - 1000000000000 + 1)) + 1000000000000)) : data.code;
                }
                
                let checkProcess = await _module.checkProcess(data.link, id, language_id);
