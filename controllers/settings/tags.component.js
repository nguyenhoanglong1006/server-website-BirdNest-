...
module.exports = (req) => {
    ...
    return new function () {
        ...
        const _module = require('./tags.module')(req);
        ...
        _this.process = async () => {
            ...
            if (Object.keys(data).length > 0) {
                ...
                if (id == 0) {
                    ...
                    data.code = (checkCode.length > 0 && checkCode[0].count == 2) ? ('t' + String(Math.floor(Math.random() * (9999999999999 - 1000000000000 + 1)) + 1000000000000)) : data.code;
                }
                ...
                if (checkProcess[0]['count'] == 0) {
                    ...
                    checkProcess = await _module.checkExitPage(data.link, id);
                    ...
                    if (checkProcess[0]['count'] == 0) {
                        ...
                        message = _lang.namePageExist;
                    }

                } else { message = _lang.nameExist; }
            }
        ...
        _this.remove = async () => {
            ...
            if (id > 0) {
                ...
                let checkRemove = await _module.checkRemove(id);
