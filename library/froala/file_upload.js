...
function isFileValid(filename, mimetype) {
  ...
  var allowedExts = ['txt', 'pdf', 'doc', 'docx', 'zip', 'rar'];
  var allowedMimeTypes = ['text/plain', 'application/msword', 'application/x-pdf', 'application/pdf', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'application/zip', 'application/x-zip-compressed', 'application/x-rar', 'application/octet-stream'];
...
function upload(req, callback) {
  ...
  var fileRoute = './uploads/froala/files/';
  ...
  busboy.on('file', function (fieldname, file, filename, encoding, mimetype) {
    ...
    if (fs.existsSync(link)) {
      ...
      return handleStreamError('File already exist or rename file then upload.');
