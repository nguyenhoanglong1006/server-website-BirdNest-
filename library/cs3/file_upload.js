...
function isFileValid(filename, mimetype) {
  ...
  var allowedExts = ['txt', 'pdf', 'doc', 'docx'];
  var allowedMimeTypes = ['text/plain', 'application/msword', 'application/pdf', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'];
